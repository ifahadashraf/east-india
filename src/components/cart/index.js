        ...
        <div className='mb-mob-2 animated fadeInUp'>
          <div>
            <div className='col-sm-12'>
              <h1 className='fw-extraBold openSans text_color_1 mt-4 mb-sm-4 mb-mob-0 pb-sm-3 fs-24'>Shopping Bag</h1>
            </div>
            <div className='col-sm-12'>
          ...
          <div className='clearfix'>
            <div className='col-sm-12 table_footer pull-right mt-4'>
              <div className='table_footer_data mb-2'>
                ...
                <div className='pull-left fw-regular openSans fs-16 text_color_1'>
                  {
                    items.reduce((sum, item) => sum + getPrice(item.variant)[1], 0)
                  }
                </div>
                <div className='clearfix'></div>
              </div>
              ...
              <div className='table_footer_data sub_total mt-3 pt-3'>
                <div className='pull-left fw-extraBold openSans fs-16 text_color_1 mr-4 mr-mob-3 pl-3 pr-mob-1'>SubTotal
                </div>
                <div className='pull-left fw-regular openSans fs-16 text_color_1'>£8.00</div>
                <div className='clearfix'></div>
              </div>
              <div className='clearfix'></div>
            </div>
            ...
            <div
              ...
              <a className='bg_color_3 text-white openSans fw-regular fs-14 rounded-10' href='#'>Proceed to Checkout</a>
            </div>
          </div>
        </div>
      </div>
